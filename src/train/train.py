...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", "-m", type=str, required=True, help="Model type.")
    parser.add_argument(
        "--project", "-p", type=str, required=True, help="Project name."
    )
    parser.add_argument(
        "--resume", "-r", type=bool, required=False, help="resume?", default=False
    )
